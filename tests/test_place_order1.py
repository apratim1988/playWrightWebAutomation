...
class TestPlaceOrder1(BaseTest):
    @pytest.mark.parametrize("data", read_test_data(Config.EXCEL_FILE_PATH, Config.get_sheet_name('place_order1')))
    def test_place_order1(self, set_up_tear_down, data, request):
